...
# ACDS 16.1 200 win32 2017.01.25.14:31:59
# ----------------------------------------
...
# ----------------------------------------
# If max10clk is one of several IP cores in your
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/max10clk.v"                                 
}
